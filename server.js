...
const db = mysql.createConnection({
  ...
  password: 'M.BHANUTEJA@2007', // MySQL password
  database: 'supercomputers_db' // Database name
});
...
// ----- ALTERNATE ENDPOINT FOR FRONTEND (alias: /api/c2c) -----
...
app.post('/api/contact', (req, res) => {
  // Accept both prefixed and plain field names
